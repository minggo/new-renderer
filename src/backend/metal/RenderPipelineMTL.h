...
public:
    ...
    inline const uint32_t getHash() const {return _hashRenderPipelineDescriptor;};
    uint32_t createHash(const RenderPipelineDescriptor& descriptor);
...
private:
    ...
    uint32_t _hashRenderPipelineDescriptor = 0;
};
